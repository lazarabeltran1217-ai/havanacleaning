  ...
  return (
    <section className="bg-ivory min-h-screen pt-36 pb-20 px-6 md:px-20">
      <div className="max-w-lg mx-auto text-center">
        ...
        <h1 className="font-display text-3xl mb-3">{t("confirmTitle")}</h1>
        <p className="text-sand text-[0.85rem] mb-6">
          {t("confirmBooking", { number: primary.bookingNumber })}
          {bookings.length > 1 && ` ${t("confirmMore", { count: bookings.length - 1 })}`}
        </p>
