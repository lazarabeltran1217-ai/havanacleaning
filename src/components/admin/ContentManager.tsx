...
const DEFAULTS = {
  ...
  hero_stats: { items: [{ value: "500+", label: "Homes Cleaned" }, { value: "4.9★", label: "Average Rating" }, { value: "100%", label: "Eco-Friendly" }] },
  trust_bar: { items: ["Fully Insured & Bonded", "Background-Checked Staff", "Same-Day Availability", "Eco-Friendly Products", "Satisfaction Guaranteed"] },
  about_section: {
    label: "Our Story",
