...
async function main() {
  ...
  const services = [
    ...
    { name: "Post-Construction", nameEs: "Post-Construcción", slug: "post-construction", description: "Construction leaves a mess — dust, debris, residue. We handle the heavy-duty cleanup so your space is move-in ready.", descriptionEs: "La construcción deja un desastre — nosotros lo limpiamos.", icon: "🔨", basePrice: 350, estimatedHours: 6, sortOrder: 5 },
